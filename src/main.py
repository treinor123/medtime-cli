    ...
    while True:
        ...
        if opcao == "1":
            ...
            if not lista:
                ...
                # Monta uma tabela bonita no terminal usando a biblioteca tabulate
                dados = [[m["id"], m["nome"], m["horario"], m["dosagem"]] for m in lista]
                print(tabulate(dados, headers=["ID", "Nome", "Horário", "Dosagem"], tablefmt="grid"))
